...
import { I{{pascalCase name}}, {{pascalCase name}}Set, UserSet, IUser } from "./";
...
export class {{pascalCase name}}Controller {
	...
	// Function to save a demand item
			...
			if (!coddyger.string.isValidObjectId(user)) {
				...
				if (!isUser) {
					resolve({
						...
						message: locale.controller.saverNotfound,
						data: null
					});
				} else if (isTitle) {
					resolve({
	...
	// Function to search {{pascalCase name}}
